...
<p align="center">
  <img src="docs/diagrams/nutrilen-class-diagram-v2.svg" alt="Diagrama UML de clases (alto nivel)" width="100%">
</p>

Fuente editable del diagrama: [docs/diagrams/nutrilen-class-diagram.mmd](docs/diagrams/nutrilen-class-diagram.mmd). Para verlo mas grande, abri el SVG: [docs/diagrams/nutrilen-class-diagram-v2.svg](docs/diagrams/nutrilen-class-diagram-v2.svg).
