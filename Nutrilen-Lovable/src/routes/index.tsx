...
import lentilImg from "@/assets/lentil-medallion.jpg";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "NutriLen — Medallón de Lenteja Saludable" },
      {
        name: "description",
        content:
          "Conocé el medallón de lenteja: alto en proteína, fuente de fibra, apto vegetariano y sin frituras.",
      },
    ],
  }),
  component: Index,
